...
def main():
    ...
    with open('DEN3_M93130.fasta', 'r') as f:
        # read fasta
    ...
    print(f"Total primer concentration: {total_primer_conc*1e6:.2f} uM")
    print(f"Dangerous total: {dang_frac*1e9:.2f} nM")
    print(f"Dangerous frac term: {normalized_dang * 1e6:.2f}")
    ...
    if results:
        ...
        print("\nAFTER OPTIMIZATION SCORE TERMS:")
        print(f"Dangerous total: {dang_frac_after*1e9:.2f} nM")
        print(f"Dangerous frac term: {normalized_dang_after * 1e6:.2f}")
